...
*                                                                            
*  Programmer: PtXml2code.exe                                                
*                                                                            
*  DESCRIPTION: Definition of 'Product test' primitives and parameter types. 
*               This file is auto generated. Do not make changes to this     
*               directly or put it under PVCS control.                       
*                                                                            
****************************************************************************/
...
*   <b>Response:</b> <i>"Status:<RsStatusType Status>"</i>
*
* - <b>Name:</b> \ref PT_CMD_SET_MODULATION_REDUCED "SetModulationReduced"<br>
*   <b>Opcode:</b> \ref PT_CMD_SET_MODULATION_REDUCED<br>
*   <b>Description:</b> This command is used to set the reduced TX modulation used for Japan DECT. The modulation will be selected immediately disregarding current DECT mode.<br>
*   <b>Command:</b> <i>"SetModulationReduced <rsuint8 Modulation>"</i><br>
*   <b>Response:</b> <i>"Status:<RsStatusType Status>"</i>
*
* - <b>Name:</b> \ref PT_CMD_GET_MODULATION_REDUCED "GetModulationReduced"<br>
*   <b>Opcode:</b> \ref PT_CMD_GET_MODULATION_REDUCED<br>
*   <b>Description:</b> This command is used to read the Japan DECT reduced TX modulation stored in the NVS.<br>
*   <b>Command:</b> <i>"GetModulationReduced"</i><br>
*   <b>Response:</b> <i>"Modulation:<rsuint8 Modulation>"</i>
*
...
*   <b>Response:</b> <i>"Status:<RsStatusType Status>"</i>
*
* - <b>Name:</b> \ref PT_CMD_START_SOC_CALIBRATION "StartSocCalibration"<br>
*   <b>Opcode:</b> \ref PT_CMD_START_SOC_CALIBRATION<br>
*   <b>Description:</b> This command is used to request the DUT to start the calibration of the SOC conversion factor through internal or external current source. SOC calibration factor is automatically written into NVS. This command only works when TestMode is set.<br>
*   <b>Command:</b> <i>"StartSocCalibration <rsuint16 Current> <rsuint16 Time>"</i><br>
*   <b>Response:</b> <i>"Status:<RsStatusType Status>"</i>
*
* - <b>Name:</b> \ref PT_CMD_GET_SOC_CALIBRATION "GetSocCalibration"<br>
*   <b>Opcode:</b> \ref PT_CMD_GET_SOC_CALIBRATION<br>
*   <b>Description:</b> This command is used to read the SOC conversion factor from the NVS.<br>
*   <b>Command:</b> <i>"GetSocCalibration"</i><br>
*   <b>Response:</b> <i>"CalibrationRunning:<rsbool CalibrationRunning> SocFactor:<rsuint16 SocFactor>"</i>
*
*
...
/*! This command is used to set the reduced TX modulation used for Japan DECT. The modulation will be selected immediately disregarding current DECT mode. <br>
Parameters: \ref PtSetModulationReducedReqType <br>
Returns: \ref PtSetModulationReducedCfmType <br>
Bat file: SetModulationReduced.bat */
#define PT_CMD_SET_MODULATION_REDUCED 0x021C

/// \ref PT_CMD_SET_MODULATION_REDUCED REQ parameter type.
typedef struct
{
  rsuint8 Modulation; //!< The modulation.
} PtSetModulationReducedReqType;

/// \ref PT_CMD_SET_MODULATION_REDUCED CFM parameter type.
typedef struct
{
  RsStatusType Status; //!< Returns RSS_SUCCESS(0) if the command succeeded or RSS_'error'(>0) if the command failed.
} PtSetModulationReducedCfmType;

/*! This command is used to read the Japan DECT reduced TX modulation stored in the NVS. <br>
Parameters: none <br>
Returns: \ref PtGetModulationReducedCfmType <br>
Bat file: GetModulationReduced.bat */
#define PT_CMD_GET_MODULATION_REDUCED 0x021D

/// \ref PT_CMD_GET_MODULATION_REDUCED CFM parameter type.
typedef struct
{
  rsuint8 Modulation; //!< The modulation.
} PtGetModulationReducedCfmType;
...
/*! This command is used to request the DUT to start the calibration of the SOC conversion factor through internal or external current source. SOC calibration factor is automatically written into NVS. This command only works when TestMode is set. <br>
Parameters: \ref PtStartSocCalibrationReqType <br>
Returns: \ref PtStartSocCalibrationCfmType <br>
Bat file: StartSocCalibration.bat */
#define PT_CMD_START_SOC_CALIBRATION 0x0307

/// \ref PT_CMD_START_SOC_CALIBRATION REQ parameter type.
typedef struct
{
  rsuint16 Current; //!< External charge current in 0.1mA. The SC144xx uses the internal current source for calibration (less accurate) if 0 is used.
  rsuint16 Time; //!< Time period [10msec] (typical 1 sec == 100 (0x64))
} PtStartSocCalibrationReqType;

/// \ref PT_CMD_START_SOC_CALIBRATION CFM parameter type.
typedef struct
{
  RsStatusType Status; //!< Returns RSS_SUCCESS(0) if the command succeeded or RSS_'error'(>0) if the command failed.
} PtStartSocCalibrationCfmType;

/*! This command is used to read the SOC conversion factor from the NVS. <br>
Parameters: none <br>
Returns: \ref PtGetSocCalibrationCfmType <br>
Bat file: GetSocCalibration.bat */
#define PT_CMD_GET_SOC_CALIBRATION 0x0308

/// \ref PT_CMD_GET_SOC_CALIBRATION CFM parameter type.
typedef struct
{
  rsbool CalibrationRunning; //!< FALSE(0): The calibration is done; TRUE(1): The calibration is still running.
  rsuint16 SocFactor; //!< The SOC factor calculated. (0xFFFF if illegal result calculated).
} PtGetSocCalibrationCfmType;
